This leon3 design is tailored to the Digilent Zybo-Z7 board
...
(leon3_digilent_zybo_z7_stub_sim.vhd) that provides clocks, reset and
...
Synthesis was tested with Vivado 2017.4.  To synthesize the design, do:
...
Always program the Zybo-Z7 via the make target 'program-zybo-z7'
...
./planAhead/leon3-digilent-zybo-z7/leon3-digilent-zybo-z7.runs/impl_1/leon3mp.bit
